      ...
      <div className="hero-wrapper">
        <div className="intro-wrapper">
          ...
          <div className="text-wrapper">
            <p>
              Howdy! My name is <b>Wasif Ali</b> and I am a web developer and
              designer. My skills include HTML, CSS, JS along with React.JS,
              PHP, Python and Databases. I have a practical field experience of
              5 years with dozens of hands-on projects. Hence professionalism
              and client satisfaction is guaranteed.
              <br />
              Other than that I am a Pianist, Guitarist and Books-Lover so feel
              free if you ever wanna have a general chit chat.
              <br />
              <code>Explore my social media accounts.</code>
            </p>
          </div>
        </div>
